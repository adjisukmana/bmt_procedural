...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2016 at 10:49 AM
...
(3, 'Adji Sukmana', 'photo.jpeg', 'adji', '35ca873f3d7296b2d3e3043fc5d6a70a', '1');
...
CREATE TABLE IF NOT EXISTS `nasabah_variable` (
  `id_nasabah` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rule_variabel` (
  `id` int(5) NOT NULL,
  `variabel` varchar(50) NOT NULL,
  `nilai_variabel` varchar(50) NOT NULL
