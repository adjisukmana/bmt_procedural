<div class="card">
	<div class="card-header">
        ...
        <a href="?p=tambah_prediksi" class="btn bgm-cyan btn-icon waves-effect pull-right waves-effect"><i class="md md-add"></i></a>
    </div>
        ...
        <table class="table table-hover" id="my-table">
            ...
            <?php
            	...
            	if ($id=='0') {
	  			    ...
	  			    $sql=mysql_query("SELECT * FROM data_prediksi WHERE no_anggota = '$id' ORDER BY id");
            	}
            ...
            <tr>
			   ...
			   <td>
                  <span class="badge"><?php echo $data['keputusan_c45']; ?></span>
               </td>
               <td>
