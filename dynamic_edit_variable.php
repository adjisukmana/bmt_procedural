...
<div class="row" ng-app="variableValue">
    <form method="POST" action='dynamic_aksi.php?module=dynamic_variable&act=edit' ng-controller="MainCtrl">
    <div class="col-md-8">
        <div class="card">
                ...
                <div class="row" >
                    ...
                    <tbody>
                        <tr data-ng-repeat="choice in choices">
                            ...
                            <td>
                                <div class="fg-line">
                                    <input type="text" name="variable_value_alias[]" class="form-control" ng-model="choice.variable_value_alias" placeholder="Masukkan alias ..." value="{{choice.variable_value_alias}}">
                                </div>
                            </td>
                            <td>
                                <div class="fg-line">
                                    <input type="text" name='variable_value_transformation[]' class="form-control"  placeholder="Masukkan transformasi data ..." value="{{choice.variable_value_transformation}}">
                                </div>
                            </td>
                            <td>
                                <div class="fg-line">
                                    <input type="text" name="variable_value_name[]" class="form-control"  placeholder="Masukkan nama variable value..." value="{{choice.variable_value_name | lowercase | removeSpaces}}">
                                </div>
                            </td>
                            <td>
...
<?php 
    ...
    ?>
    $scope.choices =  $scope.choices.concat(
                                            [{
                                                    "no": nomor,
                                                    "id_variable_value": "<?php echo $data2['id_variable_value']; ?>",
                                                    "variable_value_alias": "<?php echo $data2['variable_value_alias']; ?>",
                                                    "variable_value_transformation": "<?php echo $data2['variable_value_transformation']; ?>",
                                                    "variable_value_name": "<?php echo $data2['variable_value_name']; ?>"
                                                }
                                            ]); 
        nomor++;
    <?php } ?>        
