...
<div class="card">
    ...
    <!-- CONTENT -->
    <form method="POST" action='aksi.php?module=pegawai&act=input' enctype='multipart/form-data' align='center'>
    <div class="row m-10">
        <div class="col-sm-6"> 
                <dl class="dl-horizontal">
                    ...
                    <dd>                  
                        <div class="input-group">
                            <div class="fg-line">
                                <input type="text" class="form-control" placeholder="Masukkan No Pegawai ..." name='id_karyawan' value="<?php echo max_id('id_karyawan','karyawan'); ?>">
                            </div>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>                  
                        <div class="input-group">
                            <div class="fg-line">
                                <input type="text" class="form-control" placeholder="Masukkan Nama Pegawai ..." name='nama_karyawan'>
                            </div>
                    ...
                    <dd>                  
                        <div class="input-group p-t-10">
                            <label class="radio radio-inline m-r-20">
                                <input type="radio" name="status_karyawan" value="1">
                                <i class="input-helper"></i>  
                                Administrator
                            </label>
                            
                            <label class="radio radio-inline m-r-20">
                                <input type="radio" name="status_karyawan" value="2">
                                <i class="input-helper"></i>  
                                Pegawai
                            </label>
                        </div>
