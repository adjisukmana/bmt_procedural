<div class="row" ng-app="variableValue">
            <form method="POST" action='dynamic_aksi.php?module=dynamic_variable&act=input'>
    <div class="col-md-8">
        <div class="card">
                ...
                <div class="row"  ng-controller="MainCtrl">
                    ...
                    <tbody>
                        <tr data-ng-repeat="choice in choices">
                            ...
                            <td>
                                <div class="fg-line">
                                    <input type="text" name="variable_value_alias[]" class="form-control" ng-model="choice.name" placeholder="Masukkan alias ..." value="{{choice.name}}">
                                </div>
                            </td>
                            <td>
                                <div class="fg-line">
                                    <input type="text" name='variable_value_transformation[]' class="form-control"  placeholder="Masukkan transformasi data ..." value="{{choice.name}}">
                                </div>
                            </td>
                            <td>
                                <div class="fg-line">
                                    <input type="text" name="variable_value_name[]" class="form-control"  placeholder="Masukkan nama variable value..." value="{{choice.name | lowercase | removeSpaces}}">
                                </div>
                            </td>
                            <td>
...
var app = angular.module('variableValue', []);
  ...
  $scope.choices = [{no: '1', id_variable_value: <?php echo max_id('id_variable_value', 'variable_value'); ?>, id: 'choice1'}];
